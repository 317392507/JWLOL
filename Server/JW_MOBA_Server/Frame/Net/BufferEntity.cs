...
namespace MobaServer.Net {
    ...
    public class BufferEntity
    {
        ...
        private uint bufferHeadLenght = 32; //包头大小 根据下面计算得到的
        ...
        {
            byte[] data = new byte[bufferHeadLenght + protoSize];
            if (isAck==true)
            {
            ...
            {
                //业务数据 追加进来
                Array.Copy(proto, 0, data, bufferHeadLenght, proto.Length);
            }
            buffer = data;
            return data;
        }
       ...
       public bool isFull=false;
        ...
        private void DeCode() {
            ...
            { 
                ...
                if (buffer.Length == protoSize+ bufferHeadLenght)
                {
                    isFull = true;
                }
            }
            ...
            else
            {
                ...
                Array.Copy(buffer, bufferHeadLenght, proto, 0, protoSize);
            }
        }
